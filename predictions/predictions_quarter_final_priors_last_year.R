...
write.csv(prob_inf$prob_table, 
          file = "~/work/World-Cup-2026/results/quarter_diag_infl_biv_pois_priors_2025.csv", 
          row.names = FALSE)

ggsave("~/work/World-Cup-2026/results/plot_diag_infl_quarter_priors_2025.png", plot = p_16, width = 20, height = 15, dpi = 300)
